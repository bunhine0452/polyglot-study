/// 카드 하나의 스케줄 상태. `card_state` 테이블 한 행에 대응한다.
///
...
public struct CardSchedulingState: Hashable, Sendable, Codable {
    ...
    /// FSRS 안정성 S. 기억이 얼마나 오래 가는가 (R=90% 가 되는 간격, 일 단위).
    ...
    public var derivedFromLogID: Int64?
...
extension CardSchedulingState {
    ...
    public func isStale(activeParameterSetID: String) -> Bool {
