...
struct LearningStepOutcome: Equatable {
...
typealias LearningStepsStrategy = (
...
func convertStepUnitToMinutes(_ step: String) throws -> Int {
...
func basicLearningStepsStrategy(
