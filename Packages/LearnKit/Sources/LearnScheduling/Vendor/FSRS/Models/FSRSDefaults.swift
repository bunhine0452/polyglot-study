...
enum FSRSAlgorithmVersion: Equatable, Sendable {
    case v5
    case v6
    ...
    static func detect(_ w: [Double]) -> FSRSAlgorithmVersion {
        w.count == 21 ? .v6 : .v5
    }
}

final class FSRSDefaults: Sendable {
    ...
    static let defaultLearningSteps: [String] = ["1m", "10m"]
    /// Default relearning steps used by v6 schedulers (no effect under v5).
    static let defaultRelearningSteps: [String] = ["10m"]
